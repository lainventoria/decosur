...
class P01contact 
{
    ...
    private function panel_content()
    {
        ...
        //enable
        $c.= '<tr><td><b><label >' . $this->lang('enable') . '</label></b>';
        ...
        // language
        $c.= '<tr><td><b><label >' . $this->lang('lang') . '</label></b>';
        ...
        //message length
        $c.= '<tr><td><b><label >' . $this->lang('message_len') . '</label></b>';
        ...
        // default parameters
        $c.= '<tr><td colspan="2"><b><label >';
        $c.= $this->lang('default_params') . '</label></b>';
        $c.= '<i>' . $this->lang('default_params_sub') . '</i><br />';
        $c.= '<textarea name="p01-contact[settings][default_params]" >';
        ...
        //debug
        $c.= '<tr><td><b><label >' . $this->lang('debug') . '</label></b>';
